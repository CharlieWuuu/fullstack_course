...
function Taiwan() {
    useEffect(() => {
        document.title = '圍棋資訊網 | 海峰棋院';
    }, []);
    return (
        <main className={Styles.main}>
            <section className={Styles.taiwan}>
                <h3>關於海峰</h3>
                ...
                <p>培生文教基金會是另一個由林文伯董事長等家族捐助的財團法人，一直從事特殊教育的工作。由於資金比海峰文教基金會充裕，因此，“海峰文教基金會”併入“培生文教基金會”後，海峰文教基金會功成身退，推動棋運的棒子交給了“培生文教基金會”。原有海峰文教基金會的工作人員為因應圍棋工作需要，也做了調整，改組為「海峰棋院」，繼續在第一線從事推展圍棋工作。</p>
                <hr />
                <h3>聯絡方式：</h3>
                <ul>
